...
{
    public abstract class FlowsoftGamesActivity : AndroidGameActivity
    {
        private IFlowsoftGame _game;
        ...
        protected abstract IFlowsoftGame StartGame(CultureInfo cultureInfo);
